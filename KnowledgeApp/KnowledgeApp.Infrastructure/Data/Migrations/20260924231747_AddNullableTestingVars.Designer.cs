...
namespace KnowledgeApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260924231747_AddNullableTestingVars")]
    partial class AddNullableTestingVars
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KnowledgeApp.Infrastructure.Entities.RecommendationHistory", b =>
                {
                    ...
                    b.Property<DateTime>("RecommendedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2026, 9, 24, 23, 17, 45, 438, DateTimeKind.Utc).AddTicks(8436))
